...
libraryDependencies += "com.bot4s" %% "telegram-core" % "5.0.2"

// Extra goodies: Webhooks, support for games, bindings for actors.
libraryDependencies += "com.bot4s" %% "telegram-akka" % "5.0.2"
```

For [mill](https://www.lihaoyi.com/mill/) add to your `build.sc` project deps:
```scala
ivy"com.bot4s::telegram-core:5.0.2", // core
ivy"com.bot4s::telegram-akka:5.0.2"  // extra goodies
```
