...
abstract class RequestHandler[F[_]](
  ...
  private def sendRequestInternal[R](request: Request[R]): F[R] =
    request match {
      ...
      case s: AnswerPreCheckoutQuery =>
        sendRequest[R, AnswerPreCheckoutQuery](s)
      ...
      case s: EditMessageLiveLocation =>
        sendRequest[R, EditMessageLiveLocation](s)
      case s: EditMessageReplyMarkup =>
        sendRequest[R, EditMessageReplyMarkup](s)
      ...
      case s: SetStickerPositionInSet =>
        sendRequest[R, SetStickerPositionInSet](s)
      case s: StopMessageLiveLocation =>
        sendRequest[R, StopMessageLiveLocation](s)
  ...
  protected def processApiResponse[R](response: Response[R]): R =
    response match {
